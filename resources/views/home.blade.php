            ...
            <div class="flex flex-col md:flex-row items-center gap-16 py-12 px-8 md:px-20 bg-gray-50 rounded-3xl">
                ...
                <div class="text-center md:text-left">
                    ...
                    <div class="flex gap-3 justify-center md:justify-start">
                        ...
                        <a href="https://www.instagram.com/dhenrofiq" target="_blank" rel="noopener noreferrer" class="w-10 h-10 flex items-center justify-center bg-gray-200 rounded-lg text-gray-600 hover:bg-gray-300 hover:text-gray-800 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <a href="mailto:support@dyanaf.com" class="w-10 h-10 flex items-center justify-center bg-gray-200 rounded-lg text-gray-600 hover:bg-gray-300 hover:text-gray-800 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
