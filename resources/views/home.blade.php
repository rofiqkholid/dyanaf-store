...
@section('title', 'Dyanaf Store - Jasa Pembuatan Website, CV & Surat Lamaran Profesional')

@section('content')
<!-- Hero Section -->
<section id="home" class="relative min-h-screen flex items-start lg:items-center pt-36 lg:pt-20 pb-10 overflow-hidden">
    <!-- Background -->
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="text-center lg:text-left">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
                    <a href="#services" class="inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-semibold text-white border border-white rounded-xl hover:bg-white hover:text-gray-800 transition-all">
...
<section id="services" class="py-24 bg-white">
    <div class="container mx-auto px-6">
        ...
        <div class="text-center max-w-2xl mx-auto mb-16">
            <span class="inline-block px-4 py-1.5 bg-gray-100 text-gray-800 text-xs font-semibold uppercase tracking-wide rounded-full mb-4">Layanan Kami</span>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="group relative p-8 bg-white border border-gray-200 rounded-3xl hover:-translate-y-2 hover: hover:border-transparent transition-all duration-300">
                ...
                <ul class="space-y-2 mb-6">
                    <li class="flex items-center gap-2 text-sm text-gray-600"><span class="text-gray-600 font-bold">✓</span> Desain Modern & Responsif</li>
                    <li class="flex items-center gap-2 text-sm text-gray-600"><span class="text-gray-600 font-bold">✓</span> SEO Friendly</li>
                    <li class="flex items-center gap-2 text-sm text-gray-600"><span class="text-gray-600 font-bold">✓</span> Support & Maintenance</li>
                </ul>
            ...
            <div class="group relative p-8 gradient-primary rounded-3xl hover:-translate-y-2 hover: transition-all duration-300">
                ...
                <ul class="space-y-2 mb-6">
                    <li class="flex items-center gap-2 text-sm text-white/90"><span class="font-bold">✓</span> Desain ATS-Friendly</li>
                    <li class="flex items-center gap-2 text-sm text-white/90"><span class="font-bold">✓</span> Layout Profesional</li>
                    <li class="flex items-center gap-2 text-sm text-white/90"><span class="font-bold">✓</span> Revisi Gratis</li>
                </ul>
            ...
            <div class="group relative p-8 bg-white border border-gray-200 rounded-3xl hover:-translate-y-2 hover: hover:border-transparent transition-all duration-300">
                ...
                <ul class="space-y-2 mb-6">
                    <li class="flex items-center gap-2 text-sm text-gray-600"><span class="text-gray-600 font-bold">✓</span> Bahasa Profesional</li>
                    <li class="flex items-center gap-2 text-sm text-gray-600"><span class="text-gray-600 font-bold">✓</span> Customized Content</li>
                    <li class="flex items-center gap-2 text-sm text-gray-600"><span class="text-gray-600 font-bold">✓</span> Format Standar</li>
                </ul>
                <a href="#pricing" class="inline-flex items-center gap-1 text-sm font-semibold text-gray-700 hover:gap-2 transition-all">
                    Lihat Paket <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="m9 18 6-6-6-6" />
            ...
            <div class="group relative p-8 bg-white border border-gray-200 rounded-3xl hover:-translate-y-2 hover: hover:border-transparent transition-all duration-300">
                ...
                <ul class="space-y-2 mb-6">
                    <li class="flex items-center gap-2 text-sm text-gray-600"><span class="text-gray-600 font-bold">✓</span> Logo & Branding</li>
                    <li class="flex items-center gap-2 text-sm text-gray-600"><span class="text-gray-600 font-bold">✓</span> Social Media Assets</li>
                    <li class="flex items-center gap-2 text-sm text-gray-600"><span class="text-gray-600 font-bold">✓</span> Print Design</li>
                </ul>
                <a href="#pricing" class="inline-flex items-center gap-1 text-sm font-semibold text-gray-700 hover:gap-2 transition-all">
                    Lihat Paket <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="m9 18 6-6-6-6" />
...
<section id="pricing" class="py-24 bg-white">
    <div class="container mx-auto px-6">
        <!-- Header -->
        <div class="text-center max-w-2xl mx-auto mb-16">
            <span class="inline-block px-4 py-1.5 bg-gray-100 text-gray-800 text-xs font-semibold uppercase tracking-wide rounded-full mb-4">Harga</span>
...
<section id="testimonials" class="py-24 bg-gray-50">
    <div class="container mx-auto px-6">
        <!-- Header -->
        <div class="text-center max-w-2xl mx-auto mb-16">
            <span class="inline-block px-4 py-1.5 bg-gray-100 text-gray-800 text-xs font-semibold uppercase tracking-wide rounded-full mb-4">Testimoni</span>
...
<!-- CTA Section -->
<section id="contact" class="relative py-20 gradient-primary overflow-hidden">
    ...
    <div class="container mx-auto px-6 text-center relative z-10">
        <h2 class="text-3xl md:text-4xl font-extrabold text-white mb-4">Siap Memulai Proyek Anda?</h2>
        <p class="text-lg text-white/85 mb-8 max-w-xl mx-auto">Hubungi kami sekarang dan konsultasikan kebutuhan digital Anda secara gratis!</p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/6285881721193" target="_blank" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-gray-800 font-semibold rounded-xl hover:-translate-y-1 hover:bg-gray-100 transition-all">
            ...
            <a href="mailto:dyanaf.joki@gmail.com" class="inline-flex items-center justify-center gap-2 px-8 py-4 text-white font-semibold border-2 border-white rounded-xl hover:bg-white hover:text-gray-800 transition-all">
