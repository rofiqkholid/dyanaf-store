...
<section id="contact" class="relative py-20 gradient-primary overflow-hidden">
    ...
    <div class="container mx-auto px-6 text-center relative z-10">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/6281234567890" target="_blank" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-gray-800 font-semibold rounded-xl hover:-translate-y-1 hover:bg-gray-100 transition-all">
            ...
            <a href="mailto:hello@dyanafstore.com" class="inline-flex items-center justify-center gap-2 px-8 py-4 text-white font-semibold border-2 border-white rounded-xl hover:bg-white hover:text-gray-800 transition-all">
