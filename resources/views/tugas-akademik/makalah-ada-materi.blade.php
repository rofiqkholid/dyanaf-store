    ...
    <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-6">
                ...
                <!-- Order Button -->
                <a href="https://wa.me/6285881721193?text=Halo%20kak,%20saya%20mau%20order%20Makalah%20Ada%20Materi%20(Rp%2070.000)" target="_blank" class="flex items-center justify-center gap-2 px-8 py-3 gradient-primary text-white font-semibold rounded-xl hover:opacity-90 transition-all shadow-lg">
