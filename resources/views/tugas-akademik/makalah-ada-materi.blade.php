        ...
        <div class="flex items-center justify-between gap-3 md:gap-6">
            ...
            <div class="flex items-center gap-3 md:gap-6">
                ...
                <div class="flex flex-col items-end md:block">
                    ...
                    <span class="md:hidden text-sm font-bold text-gray-900 mb-1">Rp 70.000</span>
                    
                    <!-- Order Button -->
                    <a href="https://wa.me/6285881721193?text=Halo%20kak,%20saya%20mau%20order%20Makalah%20Ada%20Materi%20(Rp%2070.000)" target="_blank" class="flex items-center justify-center gap-2 px-4 py-2.5 md:px-8 md:py-3 gradient-primary text-white font-semibold rounded-xl hover:opacity-90 transition-all shadow-lg text-sm md:text-base">
