...
<section class="relative pt-20 pb-12 md:pt-32 md:pb-20 gradient-hero overflow-hidden">
    ...
    <div class="container mx-auto px-3 md:px-6 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <h1 class="text-2xl md:text-5xl font-bold text-white mb-6">Jasa Pembuatan Jurnal Ilmiah</h1>
            <p class="text-sm md:text-lg text-white/80 mb-8 max-w-2xl mx-auto">Pembuatan jurnal ilmiah/akademik dengan metodologi penelitian yang proper dan sesuai standar publikasi ilmiah.</p>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="space-y-8">
                <div class="flex gap-4 md:gap-6">
                    ...
                    <div>
                        <h3 class="text-lg md:text-xl font-semibold text-gray-900 mb-2">Tentukan Topik</h3>
                ...
                <div class="flex gap-4 md:gap-6">
                    ...
                    <div>
                        <h3 class="text-lg md:text-xl font-semibold text-gray-900 mb-2">Riset & Metodologi</h3>
                ...
                <div class="flex gap-4 md:gap-6">
                    ...
                    <div>
                        <h3 class="text-lg md:text-xl font-semibold text-gray-900 mb-2">Penulisan Jurnal</h3>
                ...
                <div class="flex gap-4 md:gap-6">
                    ...
                    <div>
                        <h3 class="text-lg md:text-xl font-semibold text-gray-900 mb-2">Review & Delivery</h3>
