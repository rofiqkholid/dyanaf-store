        ...
        <div class="flex items-center justify-between gap-3 md:gap-6">
            ...
            <div class="flex items-center gap-3 md:gap-6">
                ...
                <div class="hidden md:flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="font-bold text-gray-900 text-base leading-tight">Joki Tugas</h3>
                        <p class="text-lg font-extrabold text-gray-900 mt-0.5">Rp 50.000</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-end md:block">
                    ...
                    <span class="md:hidden text-sm font-bold text-gray-900 mb-1">Rp 50.000</span>
                    
                    <!-- Order Button -->
                    <a href="https://wa.me/6285881721193?text=Halo%20kak,%20saya%20mau%20order%20Joki%20Tugas%20(Rp%2050.000)" target="_blank" class="flex items-center justify-center gap-2 px-4 py-2.5 md:px-8 md:py-3 gradient-primary text-white font-semibold rounded-xl hover:opacity-90 transition-all shadow-lg text-sm md:text-base">
            ...
            <div class="flex items-center gap-3 md:gap-6">
                ...
                <div class="flex flex-col items-end md:block">
                    ...
                    <div class="md:hidden text-right mb-1">
                        <div class="text-xs text-gray-600 font-medium">Joki Tugas</div>
                        <div class="text-sm font-bold text-gray-900">Rp 50.000</div>
                    </div>
