        ...
        <div class="flex items-center justify-between gap-3 md:gap-6">
            ...
            <div class="flex items-center gap-3 md:gap-6">
                ...
                <div class="flex flex-col items-end md:block">
                    ...
                    <span class="md:hidden text-sm font-bold text-gray-900 mb-1">Rp 100.000</span>
                    
                    <!-- Order Button -->
                    <a href="https://wa.me/6285881721193?text=Halo%20kak,%20saya%20mau%20order%20Desain%20Grafis%20(Rp%20100.000)" target="_blank" class="flex items-center justify-center gap-2 px-4 py-2.5 md:px-8 md:py-3 gradient-primary text-white font-semibold rounded-xl hover:opacity-90 transition-all shadow-lg text-sm md:text-base">
            ...
            <div class="flex items-center gap-3 md:gap-6">
                ...
                <div class="flex flex-col items-end md:block">
                    ...
                    <div class="md:hidden text-right mb-1">
                        <div class="text-xs text-gray-600 font-medium">Desain Grafis</div>
